...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"><img src="enr_logo.jpg" width="100px" height="70px"></a>
    </div>
...
<div class="jumbotron text-center" height="500px">
  ...
  <form>
    ...
    <select style="width:30%;border-radius: 15px;height:40px " autofocus="true">
      <option>Pl Select Your Hostel</option>
      <optgroup label="Goverment Hostels">
        <option>Goverment Boys Hostels</option>
        <option>Goverment Girls Hostels</option>
      </optgroup>
...
<p>So this is the platform where owner can store each and every information of hosteller as well as about the hostel with few clicks. This system is designed in favour of the database management which helps them to save rent related data, food management, vacancies of rooms, guest night stay data etc.</p></h4>
    ...
    <div class="col-sm-5"> 
     <img src="hostel_logo.jpg" width="100%" height="450px">
    </div>
  </div>
</div>
...
<div id="services" class="container-fluid text-center">
    ...
    <div class="col-sm-4">
        ...
        <img class="card-img-top" src="goverment_hostel.jpeg" alt="Card image" style="width:100%;height:230px">
        <div class="card-body">
        ...
        <div class="col-sm-4">
        <div class="card" style="width:400px">
        <img class="card-img-top" src="private_hostel.jpg" alt="Card image" style="width:100%">
        <div class="card-body">
      ...
      <div class="col-sm-4">
        <div class="card" style="width:400px">
        <img class="card-img-top" src="pg.jpg" alt="Card image" style="width:100%;height:230px">
        <div class="card-body">
